...
void cone(int, int); //nombre cones, largeur

void tronc(int, int); //nombre troncs, largeur
...
void afficheForet(int nombre, int largeur){
	cone(nombre, largeur);
	tronc(nombre, largeur);


}

void cone(int nombre, int largeur){
...
void tronc(int nombre, int largeur){
